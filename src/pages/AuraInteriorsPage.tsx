  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mt-16"> {/* Added margin-top to prevent overlap with fixed header */}
        <div className="w-full bg-[#1E1E1E] pb-16">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 py-16">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-10 p-6 bg-[#F5F5F5] rounded-lg">
              <h2 className="text-2xl font-semibold mb-4 font-['DM_Sans',sans-serif] text-[#1E1E1E]">Design Details</h2>
              
              <h3 className="text-xl font-medium mb-3 font-['DM_Sans',sans-serif] text-[#1E1E1E]">Color Palette</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="flex flex-col items-center">
                  <div className="w-16 h-16 rounded-full bg-[#D08954] mb-2"></div>
                  <span className="text-sm font-['Inter',sans-serif] text-[#1E1E1E]">Burnt Orange</span>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-sm font-['Inter',sans-serif] text-[#1E1E1E]">Charcoal Black</span>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-sm font-['Inter',sans-serif] text-[#1E1E1E]">Soft White</span>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-sm font-['Inter',sans-serif] text-[#1E1E1E]">Light Gray</span>
                  <span className="text-xs font-['Inter',sans-serif] text-gray-500">#E3E3E3</span>
                </div>
              </div>
              
              <h3 className="text-xl font-medium mb-3 font-['DM_Sans',sans-serif] text-[#1E1E1E]">Typography</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-white rounded border border-[#E3E3E3]">
                  <h4 className="font-['DM_Sans',sans-serif] font-medium text-[#1E1E1E]">Primary Font</h4>
                  <p className="text-lg font-['DM_Sans',sans-serif] text-[#1E1E1E]">DM Sans</p>
                  <p className="text-sm text-gray-500 font-['DM_Sans',sans-serif]">Used for headings & body text</p>
                </div>
                <div className="p-4 bg-white rounded border border-[#E3E3E3]">
                  <h4 className="font-['Inter',sans-serif] font-medium text-[#1E1E1E]">Secondary Font</h4>
                  <p className="text-lg font-['Inter',sans-serif] text-[#1E1E1E]">Inter</p>
            ...
            <div className="flex flex-wrap gap-2 mb-8">
              <span className="inline-block bg-[#D08954] text-white text-xs px-3 py-1 rounded-full font-['Inter',sans-serif]">UI/UX Design</span>
              <span className="inline-block bg-[#D08954] text-white text-xs px-3 py-1 rounded-full font-['Inter',sans-serif]">Web Development</span>
              <span className="inline-block bg-[#D08954] text-white text-xs px-3 py-1 rounded-full font-['Inter',sans-serif]">Strategy</span>
            </div>
            
            <h2 className="text-2xl font-semibold mb-4 font-['DM_Sans',sans-serif] text-[#1E1E1E]">Project Overview</h2>
            ...
            <h2 className="text-2xl font-semibold mb-4 font-['DM_Sans',sans-serif] text-[#1E1E1E]">The Challenge</h2>
            <p className="text-gray-600 mb-8 font-['DM_Sans',sans-serif]">
            ...
            <h2 className="text-2xl font-semibold mb-4 font-['DM_Sans',sans-serif] text-[#1E1E1E]">The Solution</h2>
            <p className="text-gray-600 mb-8 font-['DM_Sans',sans-serif]">
            ...
            <h2 className="text-2xl font-semibold mb-4 font-['DM_Sans',sans-serif] text-[#1E1E1E]">Key Features</h2>
            ...
            <h2 className="text-2xl font-semibold mb-4 font-['DM_Sans',sans-serif] text-[#1E1E1E]">Results</h2>
            <p className="text-gray-600 mb-8 font-['DM_Sans',sans-serif]">
            ...
            <div className="mt-10">
              <Link 
                to="/projects" 
                className="inline-flex items-center px-4 py-2 rounded-full bg-[#D08954] text-white hover:bg-[#b87846] transition-all duration-300 group font-['Inter',sans-serif]"
              >
